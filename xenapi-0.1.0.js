...
(function() {
  "use strict";  window.XenAPI = function(username, password, hosturl) {
    var external, internal, _call, _connect, _convertJSON, _getResult, _getServerVersion, _init, _responseHandler, _serializeSession, _serializeUrl, _xmlrpc,
      _this = this;
    ...
    external.init = function(callback) {
      return _init(function(err, res) {
        if (err) {
          return callback(err);
        } else {
          return _getServerVersion(function(err, res) {
            if (err) {
              return callback(err);
            } else {
              return callback(null, internal);
