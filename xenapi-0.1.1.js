...
(function() {
  "use strict";  window.XenAPI = function(username, password, hosturl) {
    var external, internal, _call, _connect, _convertJSON, _getError, _getResult, _getServerVersion, _init, _responseHandler, _serializeSession, _serializeUrl, _xmlrpc,
      _this = this;
...
/*
//@ sourceMappingURL=xenapi-0.1.1.map
*/
