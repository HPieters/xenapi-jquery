...
(function() {
  "use strict";  window.xenapi = (function() {
    var element, functions, key, _connect, _convertJSON, _getReferenceResult, _getResult, _i, _j, _len, _len1, _ref, _ref1, _responseHandler, _serializeError, _serializeSession, _serializeUrl, _xmlrpc,
      _this = this;
    ...
    function xenapi(username, password, hosturl) {
    ...
    xenapi.prototype.getSession = function() {
      return this.session;
    };

    xenapi.prototype.getServerCall = function(method, params, callback) {
    ...
    xenapi.prototype.getServerVersion = function(callback) {
      var local;
    ...
    _ref = Object.keys(functions);
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      key = _ref[_i];
      xenapi[key].prototype = function() {
        return "Error: Please specify a operation";
      };
      _ref1 = functions[key];
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        element = _ref1[_j];
        xneapi[key][element].prototype = "Great succesa";
      }
    }
